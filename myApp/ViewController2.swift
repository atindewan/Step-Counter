...
class ViewController2: UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    @IBOutlet weak var Step_couter: UILabel!
    
    @IBOutlet weak var Bluetooth: UILabel!
    
    /* MARK: SECTION 2 - INITIALIZE YOUR OWN FUNCTIONS HERE */

    @IBAction func Add_step(_ sender: Any) {
        count += 1
        Step_couter.text = "Step Counter: " + String(count)
    }
    
    @IBAction func Subtract_step(_ sender: Any) {
        count -= 1
        Step_couter.text = "Step Counter: " + String(count)
//        if (count < 0)
//        {
//            Step_couter.text = "ERROR! Negative step."
//        }
    }
    
    func connected() {
        Bluetooth.text = "Bluetooth: Connected"
    }
    
    func disconnected() {
        Bluetooth.text = "Bluetooth: Disconnected"
    }
